...
if(isset($_SESSION["user_id"])){
		...
		$get_record = mysqli_query ($connections, "SELECT * FROM tbl_gamers where user_id='$user_id' ");
...
$roomcode=$_GET["roomcode"];
					...
					$view_query = mysqli_query($connections,"SELECT * from rooms where room_code='$room_code' "); 
